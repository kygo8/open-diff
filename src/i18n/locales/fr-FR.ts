...
export const frFR: LanguagePack = {
  ...
  messages: {
    ...
    'ui.nextDiff': 'Diff suivant',
    'ui.prevDiff': 'Diff précédent',
    ...
    'ui.fit': 'Ajuster',
    'ui.oneToOne': '1:1',
    'ui.tolerance': 'Tolérance',
    'status.compared': 'Comparé',
    'status.differences': 'Différences',
    'status.editingDisabled': 'Édition désactivée',
    'status.filesSelectedBytes': '{count} fichier(s) sélectionné(s), {bytes} octets',
    'status.loadTime': 'Temps de chargement : {seconds} secondes',
    'status.same': 'Identique',
    'status.importantDifference': 'Différence importante',
    'status.unimportantDifference': 'Différence peu importante',
    'status.importantUnimportantCounts': '{important} importantes, {unimportant} peu importantes',
    'ui.conflict': 'Conflit',
    ...
    'status.createdFolder': 'Dossier {path} créé',
    'status.createdFolders': '{count} dossiers créés',
    'status.syncOverrideApplied': 'Remplacement -> {action} ({count})',
    'status.mergeCopyToOutputApplied': 'Copier vers la sortie -> {action} ({count})',
    ...
    'ui.copyRightToLeft': 'Copier de droite à gauche',
    ...
    'ui.saveReport': 'Enregistrer le rapport',
    ...
    'ui.scriptSampleIfElse': 'Exemple IF / ELSE',
    ...
    'ui.previousConflict': 'Conflit précédent',
    ...
    'ui.selectNewer': 'Sélectionner les plus récents',
    'ui.showOrphans': 'Afficher les orphelins',
    'ui.showNoOrphans': 'Masquer les orphelins',
    'ui.showDifferencesNoOrphans': 'Afficher les différences sans orphelins',
    'ui.showLeftOrphans': 'Afficher les orphelins de gauche',
    'ui.showRightOrphans': 'Afficher les orphelins de droite',
    'ui.showLeftNewer': 'Afficher les plus récents à gauche',
    'ui.showRightNewer': 'Afficher les plus récents à droite',
    'ui.showLeftNewerAndOrphans': 'Afficher plus récents et orphelins de gauche',
    'ui.showRightNewerAndOrphans': 'Afficher plus récents et orphelins de droite',
    'ui.alwaysShowFolders': 'Toujours afficher les dossiers',
    'ui.showChanges': 'Afficher les modifications',
    'ui.showConflicts': 'Afficher les conflits',
    'ui.centerPane': 'Volet central',
    'ui.compareToOutput': 'Comparer à la sortie',
    'ui.compareToOutputHint': 'Afficher les éléments qui modifieraient le dossier de sortie.',
    'ui.compareFilesAndFolderStructure': 'Comparer fichiers et structure de dossiers',
    'ui.ignoreFolderStructure': 'Ignorer la structure des dossiers',
    'ui.compareParentFolders': 'Comparer les dossiers parents',
    'ui.compareBaseFolders': 'Comparer les dossiers de base',
    'ui.onlyCompareFiles': 'Comparer uniquement les fichiers',
    'ui.suppressFilters': 'Supprimer les filtres',
    'ui.sessionInfo': 'Infos de session',
    'ui.folderCompareInfo': 'Infos de comparaison de dossiers',
    'ui.folderSyncInfo': 'Infos de synchronisation de dossiers',
    'ui.folderMergeInfo': 'Infos de fusion de dossiers',
    'ui.sessionInfoTotal': 'Total',
    'ui.folderCompareReport': 'Rapport de comparaison de dossiers...',
    ...
    'ui.mediaSessionSettings': 'Media Session Settings',
    ...
    'ui.mergeBaseFolders': 'Fusionner les dossiers de base',
    'ui.syncBaseFolders': 'Synchroniser les dossiers de base',
    'ui.showChromeUtilities': 'Afficher les utilitaires de la barre de titre',
    'ui.showChromeUtilitiesHint':
      'Boutons langue et thème dans la barre de titre (masqués en chrome dense mono-session).',
    'ui.confirmBeforeQuit': 'Confirmer avant de quitter',
    'ui.showFolderLegendHint':
      'Show the folder status legend under Folder Compare, Sync, and Merge.',
    'ui.confirmBeforeCopy': 'Confirmer avant copie de dossier',
    'ui.confirmBeforeMove': 'Confirmer avant déplacement de dossier',
    'ui.confirmBeforeSyncDelete': 'Confirmer avant suppressions de sync',
    ...
    'ui.findNextFilename': 'Rechercher le nom de fichier suivant',
    'ui.findPreviousFilename': 'Rechercher le nom de fichier précédent',
    'ui.fullRefresh': 'Actualisation complète',
    'ui.columns': 'Colonnes',
    'ui.log': 'Journal',
    'ui.toolbar': 'Barre d’outils',
    'ui.legend': 'Légende',
    'ui.legendSameDescription': 'Fichiers identiques des deux côtés.',
    'ui.legendDifferentDescription': 'Fichiers différents entre les côtés.',
    'ui.legendOrphanDescription': 'Fichiers présents d’un seul côté (gauche seul ou droit seul).',
    'ui.legendIgnoredDescription': 'Fichiers marqués comme ignorés pour cette comparaison.',
    'ui.legendMinorDescription': 'Différences non importantes pouvant être masquées.',
    'ui.showFolderLegend': 'Afficher la légende d’état des dossiers',
    'ui.copyToOutput': 'Copier vers la sortie...',
    'ui.deleteAction': 'Supprimer...',
    'ui.renameAction': 'Rebaptiser...',
    'ui.mergeAction': 'Fusion...',

    'ui.attributes': 'Attributs...',
    'ui.newFolder': 'Nouveau dossier...',
    ...
    'ui.compareContents': 'Comparer le contenu…',
