...
export const jaJP: LanguagePack = {
  ...
  messages: {
    ...
    'ui.showDifferencesNoOrphans': '差分を表示（孤立なし）',
    'ui.showLeftOrphans': '左側の孤立を表示',
    'ui.showRightOrphans': '右側の孤立を表示',
    'ui.showLeftNewer': '左側の新しいファイルを表示',
    'ui.showRightNewer': '右側の新しいファイルを表示',
    'ui.showLeftNewerAndOrphans': '左側の新しいファイルと孤立を表示',
    'ui.showRightNewerAndOrphans': '右側の新しいファイルと孤立を表示',
    'ui.alwaysShowFolders': 'フォルダーを常に表示',
    'ui.showChanges': '変更を表示',
    'ui.showConflicts': '競合を表示',
    'ui.centerPane': '中央ペイン',
    'ui.compareToOutput': '出力と比較',
    'ui.compareToOutputHint': '出力フォルダーを変更する項目を表示します。',
    'ui.compareFilesAndFolderStructure': 'ファイルとフォルダー構造を比較',
    'ui.ignoreFolderStructure': 'フォルダー構造を無視',
    'ui.compareParentFolders': '親フォルダーを比較',
    'ui.compareBaseFolders': '基準フォルダーを比較',
    ...
    'ui.diffAlgorithm': '差分アルゴリズム',
    'ui.longFileOperationThresholdSeconds': '長い操作のしきい値（秒）',
    'ui.longFileOperationThresholdHint': 'この秒数を超えるファイル操作の後にビープします。',
    'ui.preserveTimestampsOnCopy': 'コピー時にタイムスタンプを保持',
    'ui.preserveTimestampsOnCopyHint': 'フォルダー比較のコピー後、宛先に元の更新日時を保持します。',
    'ui.overwriteReadOnlyFiles': '読み取り専用ファイルを上書き',
    ...
    'ui.reportFormat': 'レポート形式',
    'ui.reportScope': 'レポート範囲',
    'ui.reportScopeFull': '全体の比較',
    'ui.reportScopeSelection': '選択範囲',
    ...
    'status.fileCompareReportNeedsCompare':
      'ファイル比較レポートを生成する前にフォルダー比較を実行してください。',
