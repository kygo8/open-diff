...
describe('useSettingsStore', () => {
  ...
  it('persists toolbar and backup option defaults', () => {
    ...
    expect(store.showGotoInToolbar).toBe(true)
    expect(store.showWrapInToolbar).toBe(true)
    expect(store.showSyncNowInToolbar).toBe(true)
    ...
    store.setShowSessionsInToolbar(false)
    store.setShowGotoInToolbar(false)
    store.setShowWrapInToolbar(false)
    store.setShowSyncNowInToolbar(false)
    ...
    expect(localStorage.getItem('open-diff-show-sessions-in-toolbar')).toBe('0')
    expect(localStorage.getItem('open-diff-show-goto-in-toolbar')).toBe('0')
    expect(localStorage.getItem('open-diff-show-wrap-in-toolbar')).toBe('0')
    expect(localStorage.getItem('open-diff-show-sync-now-in-toolbar')).toBe('0')
  })
