...
describe('peek panel densify', () => {
  it('keeps Folder/Sync/Merge peek panels dense with tab chrome', () => {
    ...
    expect(css).toMatch(/\.folder-peek-panel,[\s\S]*?padding:\s*0 1px/)
    ...
    expect(folderView).toMatch(/\.folder-peek-panel\s*\{[\s\S]*?padding:\s*0 1px/)
    ...
    expect(syncView).toMatch(/\.folder-sync-peek-panel\s*\{[\s\S]*?padding:\s*0 1px/)
    ...
    expect(mergeView).toMatch(/\.folder-merge-peek-panel\s*\{[\s\S]*?padding:\s*0 1px/)
