...
describe('peek panel densify', () => {
  it('keeps Folder/Sync/Merge peek panels dense with tab chrome', () => {
    ...
    expect(css).toMatch(/\.folder-peek-panel dl > div,[\s\S]*?min-height:\s*11px/)
    ...
    expect(folderView).toMatch(/data-peek-density="capture-pass9"/)
    ...
    expect(syncView).toMatch(/data-peek-density="capture-pass9"/)
    ...
    expect(mergeView).toMatch(/data-peek-density="capture-pass9"/)
