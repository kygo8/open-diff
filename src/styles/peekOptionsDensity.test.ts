...
describe('peek panel densify', () => {
  it('keeps Folder/Sync/Merge peek panels dense with tab chrome', () => {
    ...
    expect(folderView).toMatch(/data-peek-density="capture-pass10"/)
    ...
    expect(syncView).toMatch(/data-peek-density="capture-pass10"/)
    ...
    expect(mergeView).toMatch(/data-peek-density="capture-pass10"/)
