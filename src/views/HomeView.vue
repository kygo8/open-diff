...
<template>
  ...
  >
    <section
      ...
      data-home-density="capture-pass11"
...
.bc-session-tree {
  display: grid;
  grid-template-rows: 10px minmax(0, 1fr) 11px;
  min-width: 0;
  min-height: 0;
...
.bc-tree-row {
  display: grid;
  grid-template-columns: 8px 9px minmax(0, 1fr);
  align-items: center;
  gap: 1px;
  width: 100%;
  min-height: 9px;
...
.bc-tree-footer {
  display: grid;
  grid-template-columns: 9px 9px minmax(0, 1fr);
  align-items: center;
  gap: 1px;
  padding: 1px;
