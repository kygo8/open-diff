...
<template>
  ...
  >
    <section
      ...
      data-home-density="capture-pass10"
...
.bc-home-workspace {
  ...
  /* Capture-aligned left tree; pass-10 denser non-web-card column toward home.png. */
...
.bc-session-tree {
  display: grid;
  grid-template-rows: 11px minmax(0, 1fr) 12px;
  min-width: 0;
  min-height: 0;
...
.bc-tree-row {
  display: grid;
  grid-template-columns: 8px 10px minmax(0, 1fr);
  align-items: center;
  gap: 1px;
  width: 100%;
  min-height: 10px;
...
.bc-tree-footer {
  display: grid;
  grid-template-columns: 10px 10px minmax(0, 1fr);
  align-items: center;
  gap: 1px;
  padding: 1px;
