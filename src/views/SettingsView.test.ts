...
describe('SettingsView', () => {
  ...
  it('exposes tree-style options for toolbars, open with, shell, and backup', async () => {
    ...
    await wrapper.find('[data-testid="show-sessions-in-toolbar"]').setValue(false)
    expect(settings.showSessionsInToolbar).toBe(false)
    await wrapper.find('[data-testid="show-goto-in-toolbar"]').setValue(false)
    expect(settings.showGotoInToolbar).toBe(false)
    await wrapper.find('[data-testid="show-wrap-in-toolbar"]').setValue(false)
    expect(settings.showWrapInToolbar).toBe(false)
    await wrapper.find('[data-testid="show-sync-now-in-toolbar"]').setValue(false)
